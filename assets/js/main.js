...
function updateViewport() {
  document.getElementById('lol_w').innerHTML = verge.viewportW();
  document.getElementById('lol_h').innerHTML = verge.viewportH();
}
...
function updateScreenRes() {
  document.getElementById('lol_screen_w').innerHTML = window.screen.width;
  document.getElementById('lol_screen_h').innerHTML = window.screen.height;
}
